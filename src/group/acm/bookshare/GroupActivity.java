...
public class GroupActivity extends Activity {
	...
	{
		data.clear();
		List<Friend> list = new ArrayList<Friend>(localUser.getGroup());
        for(Friend i:list){
								...
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										localUser.deleteFriend(
												data.get(JudgeListener.this.position),
												new DeleteFriendHandler());
										removeListItem(listView.getChildAt(JudgeListener.this.position),JudgeListener.this.position);
									}
	 ...
	 private class DeleteFriendHandler extends Handler {
			...
			public void handleMessage(Message msg) {
				...
				case NetAccess.NETMSG_ERROR:
					GroupActivity.this.showToast(msg.getData()
							.getString("error"));
					break;
				}
			}
    ...
    public class MyAdapter extends BaseAdapter {      
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {  
            ...
            if(convertView == null) {  
                ...
                holder.groupname = (TextView)convertView.findViewById(R.id.mygrouplistitem_groupname); 
            ...
            holder.image.setBackgroundResource((Integer)data.get(position).get("groupimage"));
            holder.groupname.setText((String)(data.get(position).get("username")));           
