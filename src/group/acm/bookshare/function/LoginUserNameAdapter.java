...
public class LoginUserNameAdapter extends BaseAdapter {
	 ...
	 * @param list
	 */
    public LoginUserNameAdapter(Activity activity,Handler handler,ArrayList<String> list){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) { 
            ...
            //下拉项布局
            convertView = LayoutInflater.from(activity).inflate(R.layout.user_name_item, null); 
            holder.textView = (TextView) convertView.findViewById(R.id.user_name_item_text); 
